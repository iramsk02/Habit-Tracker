...
//     { id: '2', title: 'Sleep' },
//     { id: '3', title: 'Exercise' },
//     { id: '4', title: 'Screen Time' }
//   ]);
//   const streak = 6;
//   const [activeTab, setActiveTab] = useState('today');

//   const handleDelete = (id: string) => {
//     // Remove habit with the specified id
...
//               className={`px-6 py-2 rounded-md text-sm font-medium transition ${activeTab === 'today' ? 'bg-blue-600 text-white' : 'text-gray-600 hover:text-blue-600'
//                 }`}
//             >
//               Today
//             </button>
...
//               className={`px-6 py-2 rounded-md text-sm font-medium transition ${activeTab === 'stats' ? 'bg-blue-600 text-white' : 'text-gray-600 hover:text-blue-600'
//                 }`}
//             >
//               Stats
//             </button>
...
//               className={`px-6 py-2 rounded-md text-sm font-medium transition ${activeTab === 'calendar' ? 'bg-blue-600 text-white' : 'text-gray-600 hover:text-blue-600'
//                 }`}
//             >
//               Calendar
//             </button>
...
//                   max={100}
//                   color="blue"
//                   onDelete={handleDelete} // Handle delete by id
//                 />
//               ))}
//               {/* <HabitCard
...
//                 max={10}
//                 color="blue"
//                 onDelete={handleDeleteHabit("water")}
//               />
//               <HabitCard
